...
LOGGING = {
    ...
    "handlers": {
        ...
        "stream_to_stderr": {"level": "WARN", "class": "logging.StreamHandler"},
    },
    "loggers": {
        "django": {
...
PIPELINE_CSS = {
    "countdown": {
        "source_filenames": ("css/jquery.countdown-v1.6.0.css", "sass/countdown.scss"),
...
PIPELINE_JS = {
    ...
    "feeds": {"source_filenames": ("js/feeds.js",), "output_filename": "js/feeds.js"},
    "responsive-carousel": {
