    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(to='contenttypes.ContentType', on_delete=models.CASCADE), on_delete=models.CASCADE),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.PositiveIntegerField()),
                ('content_type', models.ForeignKey(related_name='pombola_identifier_set', to='contenttypes.ContentType', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.ForeignKey(to='core.Organisation', on_delete=models.CASCADE), on_delete=models.CASCADE),
            ],
            options={
                'ordering': ['start_date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(to='core.Person', on_delete=models.CASCADE), on_delete=models.CASCADE),
        ...
        migrations.AddField(
            model_name='position',
            name='title',
            field=models.ForeignKey(blank=True, to='core.PositionTitle', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='place',
            name='kind',
            field=models.ForeignKey(to='core.PlaceKind', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='place',
            name='mapit_area',
            field=models.ForeignKey(blank=True, to='mapit.Area', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='place',
            name='organisation',
            field=models.ForeignKey(blank=True, to='core.Organisation', help_text=b'use if the place uniquely belongs to an organisation - eg a field office', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='place',
            name='parent_place',
            field=models.ForeignKey(related_name='child_places', blank=True, to='core.Place', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='place',
            name='parliamentary_session',
            field=models.ForeignKey(blank=True, to='core.ParliamentarySession', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='organisationrelationship',
            name='kind',
            field=models.ForeignKey(to='core.OrganisationRelationshipKind', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='organisationrelationship',
            name='organisation_a',
            field=models.ForeignKey(related_name='org_rels_as_a', to='core.Organisation', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='organisationrelationship',
            name='organisation_b',
            field=models.ForeignKey(related_name='org_rels_as_b', to='core.Organisation', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='organisation',
            name='kind',
            field=models.ForeignKey(to='core.OrganisationKind', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        ...
        migrations.AddField(
            model_name='contact',
            name='kind',
            field=models.ForeignKey(to='core.ContactKind', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alternativepersonname',
            name='person',
            field=models.ForeignKey(related_name='alternative_names', to='core.Person', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='alternativepersonname',
