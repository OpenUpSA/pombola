$(function () {
  ...
  $('.js-hover-dropdown').each(function () {
    ...
    var touch = function (e) {
      e.preventDefault();
      // remove lingering hover class: fixes bug where multiple dropdown menus
      // would be shown on touch devices
      if (window.innerWidth > 767) {
        $('.dropdown').removeClass('js-hover-active');
      } else {
        $parent.find(".svg-icon").toggleClass("info-expand__trigger--open");
      }
      ...
      $parent.toggleClass('js-hover-active');
    }
