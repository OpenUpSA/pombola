    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, verbose_name='modified', editable=False)),
                ('agreement', models.IntegerField(choices=[(-2, b'strongly disagree'), (-1, b'disagree'), (0, b'neutral'), (1, b'agree'), (2, b'strongly agree')])),
                ('party', models.ForeignKey(to='votematch.Party', on_delete=models.CASCADE), on_delete=models.CASCADE),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(to='votematch.Quiz', on_delete=models.CASCADE), on_delete=models.CASCADE),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='stance',
            name='statement',
            field=models.ForeignKey(to='votematch.Statement', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='party',
            name='quiz',
            field=models.ForeignKey(to='votematch.Quiz', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='answer',
        ...
        migrations.AddField(
            model_name='answer',
            name='submission',
            field=models.ForeignKey(to='votematch.Submission', on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
