...
final_candidate_list_date = ApproximateDate(year=2024, month=4, day=23)
month_before_final_list_date = ApproximateDate(year=2024, month=3)
...
csv_files = [
    'regional-candidates.csv'
]

candidates = []

for candidates_csv in csv_files:
    with open("pombola/south_africa/data/elections/2024/" + candidates_csv, "rb") as csvfile:
...
def save_match(
    ...
    if COMMIT:
        person.identifiers.get_or_create(scheme='elections_2024', identifier=id_number)
